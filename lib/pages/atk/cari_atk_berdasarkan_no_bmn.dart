...
import 'package:gudang_fk/controller/atk/cari_atk_berdasarkan_no_bmn_controller.dart';
import 'package:pdf/widgets.dart' as pw;
import 'package:printing/printing.dart';
import 'package:pdf/pdf.dart';

class CariAtkBerdasarkanNoBmn extends StatefulWidget {
  const CariAtkBerdasarkanNoBmn({super.key});

  @override
  State<CariAtkBerdasarkanNoBmn> createState() =>
      _CariAtkBerdasarkanNoBmnState();
}

class _CariAtkBerdasarkanNoBmnState
    extends State<CariAtkBerdasarkanNoBmn> {
  final TextEditingController _searchController = TextEditingController();
  final ControllerCariAtkNoBMN _controller = ControllerCariAtkNoBMN();
